class SearchesController < ApplicationController
  def index
    ...
    sort_string = sort_string + ', ' + params[:sort_field_2] + ' ' + params[:sort_order_2] if params[:sort_field_2] != 'none'
    sort_string = sort_string + ', ' + params[:sort_field_3] + ' ' + params[:sort_order_3] if params[:sort_field_3] != 'none'
